...
<html>
	...
	<head>
		...
		<link rel="icon" href="<%=request.getContextPath()%>/MyPages/ico.ico" type="image/x-icon">
	</head>

	<body>
		<div align="right">
			<a href="<%=request.getContextPath()%>/MyPages/CDKeyManager.jsp" style="margin-right: 50px">注册码管理系统</a>
			<%
			String flag = "";
		...
		%> 管理员，您好！
			<a href="<%=request.getContextPath()%>/LogoutServlet" style="margin-left: 10px">退出</a>
			<%
			} else {
		%>
		...
		<br />
		<table width="100%" height="600px" style="background-color: #2f3640; color: #a6b0b9">
			<tr>
				...
				<td rowspan="1" style="background-color: #eeeeee; color: #292929">
					...
					if (flag.equals("login_success")) {
				%>
					<table width="98%" border="1" cellspacing="0" cellpadding="5" bordercolor="silver" align="center">
						<tr bgcolor="#E8E8E8">
							<td colspan="2"></td>
